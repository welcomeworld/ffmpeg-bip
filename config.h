...
#define FFMPEG_CONFIGURATION "--prefix=/PublicData/ffmpeg/ffmpeg-4.2.4/android/armeabi-v7a --libdir=/PublicData/ffmpeg/ffmpeg-4.2.4/android/libs/armeabi-v7a --enable-shared --enable-jni --enable-gpl --enable-openssl --enable-nonfree --enable-mediacodec --enable-libx264 --disable-doc --disable-static --disable-ffmpeg --disable-ffplay --disable-ffprobe --disable-symver --disable-programs --disable-demuxer=image_png_pipe --target-os=android --arch=arm --cpu=armv7-a --cc=/PublicData/LinuxAndroidSdk/ndk/21.3.6528147/toolchains/llvm/prebuilt/linux-x86_64/bin/armv7a-linux-androideabi29-clang --cxx=/PublicData/LinuxAndroidSdk/ndk/21.3.6528147/toolchains/llvm/prebuilt/linux-x86_64/bin/armv7a-linux-androideabi29-clang++ --enable-cross-compile --cross-prefix=/PublicData/LinuxAndroidSdk/ndk/21.3.6528147/toolchains/llvm/prebuilt/linux-x86_64/bin/arm-linux-androideabi- --sysroot=/PublicData/LinuxAndroidSdk/ndk/21.3.6528147/toolchains/llvm/prebuilt/linux-x86_64/sysroot --disable-asm --disable-x86asm --extra-cflags='-I/PublicData/openssl/openssl_1_1_1l/android/arm/include -I/PublicDataBackup/libx264/x264/android/arm/include -fPIE -pie -Os -fpic -march=armv7-a' --extra-ldflags='-L/PublicData/openssl/openssl_1_1_1l/android/arm/lib -L/PublicDataBackup/libx264/x264/android/arm/lib '"
#define FFMPEG_LICENSE "nonfree and unredistributable"
#define CONFIG_THIS_YEAR 2020
#define FFMPEG_DATADIR "/PublicData/ffmpeg/ffmpeg-4.2.4/android/armeabi-v7a/share/ffmpeg"
#define AVCONV_DATADIR "/PublicData/ffmpeg/ffmpeg-4.2.4/android/armeabi-v7a/share/ffmpeg"
